...
from util import predict, save_images, load_test_data
...
# Start training
with tf.device('/gpu:1'):
    model.fit_generator(train_generator, callbacks=None, validation_data=test_generator, epochs=args.epochs, shuffle=True)
